...
/**
 * SupplierChghist generated by hbm2java
 */
@Entity
@Table(name = "SUPPLIER_CHGHIST", schema = "PCRM")
public class SupplierChghist implements java.io.Serializable {
	...
	public SupplierChghist() {
	}

	public SupplierChghist(String audId) {
		this.audId = audId;
	}

	public SupplierChghist(String audId, String audAction,
			...
			Date crt, String code, String head, String primlevtype,
	...
	@Column(name = "PRIMLEVTYPE", length = 19)
	public String getPrimlevtype() {
		return this.primlevtype;
	}

	public void setPrimlevtype(String primlevtype) {
		this.primlevtype = primlevtype;
	}
