...
/**
 * SubcontractorChghist generated by hbm2java
 */
@Entity
@Table(name = "SUBCONTRACTOR_CHGHIST", schema = "PCRM")
public class SubcontractorChghist implements java.io.Serializable {
	...
	public SubcontractorChghist() {
	}

	public SubcontractorChghist(String audId, String id, String scode,
	...
	public SubcontractorChghist(String audId, String audAction,
