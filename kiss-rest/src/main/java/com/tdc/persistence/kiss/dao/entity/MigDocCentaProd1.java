...
/**
 * MigDocCentaProd1 generated by hbm2java
 */
@Entity
@Table(name = "MIG_DOC_CENTA_PROD_1", schema = "PCRM")
public class MigDocCentaProd1 implements java.io.Serializable {
	...
	public MigDocCentaProd1() {
	}

	public MigDocCentaProd1(BigDecimal id) {
		this.id = id;
	}

	public MigDocCentaProd1(BigDecimal id, String fileName, String fullname,
