...
/**
 * TestWorksmartDataId generated by hbm2java
 */
@Embeddable
public class TestWorksmartDataId implements java.io.Serializable {
	...
	public TestWorksmartDataId() {
	}

	public TestWorksmartDataId(BigDecimal id, String fileName, String fullname,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TestWorksmartDataId))
			return false;
		TestWorksmartDataId castOther = (TestWorksmartDataId) other;
