...
/**
 * ToadPlanTable generated by hbm2java
 */
@Entity
@Table(name = "TOAD_PLAN_TABLE", schema = "PCRM")
public class ToadPlanTable implements java.io.Serializable {

	private ToadPlanTableId id;

	public ToadPlanTable() {
	}

	public ToadPlanTable(ToadPlanTableId id) {
		this.id = id;
	}
	...
	public ToadPlanTableId getId() {
		return this.id;
	}

	public void setId(ToadPlanTableId id) {
		this.id = id;
	}
