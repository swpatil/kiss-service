...
/**
 * DocsectionheadChghist generated by hbm2java
 */
@Entity
@Table(name = "DOCSECTIONHEAD_CHGHIST", schema = "PCRM")
public class DocsectionheadChghist implements java.io.Serializable {
	...
	public DocsectionheadChghist() {
	}

	public DocsectionheadChghist(String audId, String id) {
		this.audId = audId;
		this.id = id;
	}

	public DocsectionheadChghist(String audId, String audAction,
			...
			Date crt, String code, String head, String primdoctopic,
			Date startDate, Date endDate, Integer userkey, String logtrace) {
		this.audId = audId;
	...
	@Column(name = "USERKEY", precision = 5, scale = 0)
