...
/**
 * SgiconChghist generated by hbm2java
 */
@Entity
@Table(name = "SGICON_CHGHIST", schema = "PCRM")
public class SgiconChghist implements java.io.Serializable {
	...
	private String primsglocation;
	private String tooltip;

	public SgiconChghist() {
	}

	public SgiconChghist(String audId, String id, String code,
			String primsglocation) {
		this.audId = audId;
		this.id = id;
		this.code = code;
		this.primsglocation = primsglocation;
	}

	public SgiconChghist(String audId, String audAction,
			...
			String assetReference, String isdefault, String isheader,
			String primsglocation, String tooltip) {
		this.audId = audId;
	...
	@Column(name = "PRIMSGLOCATION", nullable = false, length = 19)
	public String getPrimsglocation() {
		return this.primsglocation;
	}

	public void setPrimsglocation(String primsglocation) {
		this.primsglocation = primsglocation;
	}
