...
/**
 * RuleLog generated by hbm2java
 */
@Entity
@Table(name = "RULE_LOG", schema = "PCRM")
public class RuleLog implements java.io.Serializable {
	...
	public RuleLog(String id, String ruleName) {
		this.id = id;
		this.ruleName = ruleName;
	}

	public RuleLog(String id, String ruleName, Date impt, Date expt, Date impd,
			Date expd, Date modt, String cru, Date delt, Date modd,
			String impu, String expu, Date deld, String modu, String delu,
			Date crt, Date startDate, Date endDate, String ruleNumber) {
		this.id = id;
		this.ruleName = ruleName;
		this.impt = impt;
		this.expt = expt;
	...
	@Column(name = "RULE_NAME", nullable = false, length = 75)
	...
	@Column(name = "RULE_NUMBER", length = 19)
