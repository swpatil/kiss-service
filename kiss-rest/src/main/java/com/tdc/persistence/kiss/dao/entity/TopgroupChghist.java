...
/**
 * TopgroupChghist generated by hbm2java
 */
@Entity
@Table(name = "TOPGROUP_CHGHIST", schema = "PCRM")
public class TopgroupChghist implements java.io.Serializable {
	...
	public TopgroupChghist() {
	}

	public TopgroupChghist(String audId, String id) {
		this.audId = audId;
		this.id = id;
	}

	public TopgroupChghist(String audId, String audAction,
			...
			String modu, String head, String delu, Date crt, String oldcode,
			Date startDate, Date endDate, String userkey, String logtrace) {
		this.audId = audId;
