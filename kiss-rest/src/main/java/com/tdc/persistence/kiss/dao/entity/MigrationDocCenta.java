...
/**
 * MigrationDocCenta generated by hbm2java
 */
@Entity
@Table(name = "MIGRATION_DOC_CENTA", schema = "PCRM")
public class MigrationDocCenta implements java.io.Serializable {

	private MigrationDocCentaId id;

	public MigrationDocCenta() {
	}

	public MigrationDocCenta(MigrationDocCentaId id) {
		this.id = id;
	}
	...
	public MigrationDocCentaId getId() {
		return this.id;
	}

	public void setId(MigrationDocCentaId id) {
		this.id = id;
	}
