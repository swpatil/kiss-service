...
/**
 * CrDocsecthead2originChghist generated by hbm2java
 */
@Entity
@Table(name = "CR_DOCSECTHEAD2ORIGIN_CHGHIST", schema = "PCRM")
public class CrDocsecthead2originChghist implements java.io.Serializable {
	...
	public CrDocsecthead2originChghist() {
	}

	public CrDocsecthead2originChghist(String audId) {
		this.audId = audId;
	}

	public CrDocsecthead2originChghist(String audId, String audAction,
			Serializable audTimestamp, String audOsuser, String audDbuser,
			String audUserterminal, String primdocsectionhead,
