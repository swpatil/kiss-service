...
/**
 * PartyChghistDrop generated by hbm2java
 */
@Entity
@Table(name = "PARTY_CHGHIST_DROP", schema = "PCRM")
public class PartyChghistDrop implements java.io.Serializable {
	...
	public PartyChghistDrop() {
	}

	public PartyChghistDrop(String audId) {
		this.audId = audId;
	}

	public PartyChghistDrop(String audId, String audAction,
			Serializable audTimestamp, String audOsuser, String audDbuser,
			String audUserterminal, String id, String education,
			String primcont, String town, Date impt, String primsour,
			Date deld, String addr3, Character mailstop, Date crd, String expu,
			Date crt, String primcomp, Byte loyalty, String email,
			String postcode, String modu, String addr4, String cru, Date impd,
