...
/**
 * RequestreplyChghist generated by hbm2java
 */
@Entity
@Table(name = "REQUESTREPLY_CHGHIST", schema = "PCRM")
public class RequestreplyChghist implements java.io.Serializable {
	...
	public RequestreplyChghist() {
	}

	public RequestreplyChghist(String audId) {
		this.audId = audId;
	}

	public RequestreplyChghist(String audId, String audAction,
			...
			Date crt, String code, String head, String primaryopslagstype,
			String primaryklasseopslag, String primanltbo, String question,
			String answer) {
		this.audId = audId;
