...
/**
 * MigDocIProdId generated by hbm2java
 */
@Embeddable
public class MigDocIProdId implements java.io.Serializable {
	...
	public MigDocIProdId() {
	}

	public MigDocIProdId(BigDecimal id, String fileName, String fullname,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MigDocIProdId))
			return false;
		MigDocIProdId castOther = (MigDocIProdId) other;
