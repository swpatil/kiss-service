...
/**
 * Sf2076IdriveB4 generated by hbm2java
 */
@Entity
@Table(name = "SF_2076_IDRIVE_B4", schema = "PCRM")
public class Sf2076IdriveB4 implements java.io.Serializable {
	...
	private String sfDocument;

	public Sf2076IdriveB4() {
	}

	public Sf2076IdriveB4(BigDecimal id, String sfDocument) {
		this.id = id;
		this.sfDocument = sfDocument;
	}

	public Sf2076IdriveB4(BigDecimal id, String fileName, String fullname,
			String idrivepath, String bucketName, String pathprefix,
			String cableunitno, String caseno, String customerNumber,
			String constructionProjectNumber, String constrHierarchyNumber,
			String sfid, String headendnumber, String contentSize,
			String fileSizeMb, String timestampcol, String version,
			String contentType, String fileLabel, String kissDoctype,
			String centaDocCategory, String centaDoctype, String documentId,
			String extension, String offerid, String supplierrequestid,
			String mid, String department, String created, Date crd,
			String lastmodifieddate, Date modd, String docremark,
			String systemid, String amazonpath, String transferstatus,
			String description, String isactive, String access,
			String documentTag, String sfDocumentId, String sfDocument) {
		this.id = id;
	...
	@Column(name = "SF_DOCUMENT", nullable = false, length = 1000)
	public String getSfDocument() {
		return this.sfDocument;
	}

	public void setSfDocument(String sfDocument) {
		this.sfDocument = sfDocument;
	}
