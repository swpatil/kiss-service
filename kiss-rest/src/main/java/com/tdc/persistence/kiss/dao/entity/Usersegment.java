...
/**
 * Usersegment generated by hbm2java
 */
@Entity
@Table(name = "USERSEGMENT", schema = "PCRM")
public class Usersegment implements java.io.Serializable {
	...
	public Usersegment(String id) {
		this.id = id;
	}

	public Usersegment(String id, Date crd, Date impt, Date expt, Date impd,
			Date expd, Date modt, String cru, Date delt, Date modd,
			String impu, String expu, Date deld, String modu, String delu,
			Date crt, String code, String head, String virtualkey) {
		this.id = id;
		this.crd = crd;
		this.impt = impt;
		this.expt = expt;
