 ...
 */
@Entity
@Table(name = "LOCALITY", schema = "PCRM")
public class Locality implements java.io.Serializable {
	...
	public Locality(String id, Date crd, Date crt, String cru, Date modd,
			Date modt, String modu, Date deld, Date delt, String delu,
			Date impd, Date impt, String impu, Date expd, Date expt,
			String expu, String primaryadresse, String code, String heading,
			Long addressid) {
		this.id = id;
		this.crd = crd;
		this.crt = crt;
