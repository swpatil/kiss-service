...
/**
 * RequeststatetypeChghist generated by hbm2java
 */
@Entity
@Table(name = "REQUESTSTATETYPE_CHGHIST", schema = "PCRM")
public class RequeststatetypeChghist implements java.io.Serializable {
	...
	public RequeststatetypeChghist() {
	}

	public RequeststatetypeChghist(String audId) {
		this.audId = audId;
	}

	public RequeststatetypeChghist(String audId, String audAction,
