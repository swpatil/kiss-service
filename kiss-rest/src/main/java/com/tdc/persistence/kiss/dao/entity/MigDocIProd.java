...
/**
 * MigDocIProd generated by hbm2java
 */
@Entity
@Table(name = "MIG_DOC_I_PROD", schema = "PCRM")
public class MigDocIProd implements java.io.Serializable {

	private MigDocIProdId id;

	public MigDocIProd() {
	}

	public MigDocIProd(MigDocIProdId id) {
		this.id = id;
	}
	...
	public MigDocIProdId getId() {
		return this.id;
	}

	public void setId(MigDocIProdId id) {
		this.id = id;
	}
