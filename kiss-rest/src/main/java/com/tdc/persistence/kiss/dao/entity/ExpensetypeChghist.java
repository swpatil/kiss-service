...
/**
 * ExpensetypeChghist generated by hbm2java
 */
@Entity
@Table(name = "EXPENSETYPE_CHGHIST", schema = "PCRM")
public class ExpensetypeChghist implements java.io.Serializable {
	...
	public ExpensetypeChghist() {
	}

	public ExpensetypeChghist(String audId) {
		this.audId = audId;
	}

	public ExpensetypeChghist(String audId, String audAction,
