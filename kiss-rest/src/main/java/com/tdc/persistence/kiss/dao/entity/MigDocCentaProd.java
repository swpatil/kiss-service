...
/**
 * MigDocCentaProd generated by hbm2java
 */
@Entity
@Table(name = "MIG_DOC_CENTA_PROD", schema = "PCRM")
public class MigDocCentaProd implements java.io.Serializable {

	private MigDocCentaProdId id;

	public MigDocCentaProd() {
	}

	public MigDocCentaProd(MigDocCentaProdId id) {
		this.id = id;
	}
	...
	public MigDocCentaProdId getId() {
		return this.id;
	}

	public void setId(MigDocCentaProdId id) {
		this.id = id;
	}
