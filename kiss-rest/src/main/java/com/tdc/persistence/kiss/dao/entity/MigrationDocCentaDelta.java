...
/**
 * MigrationDocCentaDelta generated by hbm2java
 */
@Entity
@Table(name = "MIGRATION_DOC_CENTA_DELTA", schema = "PCRM")
public class MigrationDocCentaDelta implements java.io.Serializable {
	...
	public MigrationDocCentaDelta() {
	}

	public MigrationDocCentaDelta(BigDecimal id) {
		this.id = id;
	}

	public MigrationDocCentaDelta(BigDecimal id, String fileName,
