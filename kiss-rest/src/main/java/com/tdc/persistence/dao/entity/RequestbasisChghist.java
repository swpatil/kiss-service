...
/**
 * RequestbasisChghist generated by hbm2java
 */
@Entity
@Table(name = "REQUESTBASIS_CHGHIST", schema = "PCRM")
public class RequestbasisChghist implements java.io.Serializable {
	...
	public RequestbasisChghist() {
	}

	public RequestbasisChghist(String audId) {
		this.audId = audId;
	}

	public RequestbasisChghist(String audId, String audAction,
			...
			String primarysag, String primaryklasseopslag, String endid,
