...
/**
 * DoctopicChghist generated by hbm2java
 */
@Entity
@Table(name = "DOCTOPIC_CHGHIST", schema = "PCRM")
public class DoctopicChghist implements java.io.Serializable {
	...
	public DoctopicChghist() {
	}

	public DoctopicChghist(String audId) {
		this.audId = audId;
	}

	public DoctopicChghist(String audId, String audAction,
			...
			Date expd, String expu, String code, String head, String key2rule,
