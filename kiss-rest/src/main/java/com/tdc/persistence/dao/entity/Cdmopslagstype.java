...
/**
 * Cdmopslagstype generated by hbm2java
 */
@Entity
@Table(name = "CDMOPSLAGSTYPE", schema = "PCRM")
public class Cdmopslagstype implements java.io.Serializable {

	private CdmopslagstypeId id;

	public Cdmopslagstype() {
	}

	public Cdmopslagstype(CdmopslagstypeId id) {
		this.id = id;
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "multiplechoice", column = @Column(name = "MULTIPLECHOICE", length = 1)),
			@AttributeOverride(name = "rebmun", column = @Column(name = "REBMUN", precision = 10, scale = 0)) })
	public CdmopslagstypeId getId() {
		return this.id;
	}

	public void setId(CdmopslagstypeId id) {
		this.id = id;
	}
