...
/**
 * Sf2073TestDataId generated by hbm2java
 */
@Embeddable
public class Sf2073TestDataId implements java.io.Serializable {

	private String centaDocumentNameC;
	private String cloudFileAccessC;
	private String cloudFileAllCategoriesC;
	private String cloudFileAllDocument;
	...
	private String cloudFileFullNameC;
	private String cloudHierarchiCustNoC;
	...
	private String cloudFileSupplietidC;
	...
	public Sf2073TestDataId() {
	}

	public Sf2073TestDataId(String centaDocumentNameC, String cloudFileAccessC,
			String cloudFileAllCategoriesC, String cloudFileAllDocument,
			String cloudFileBucketNameC, String cloudFileCaseNoC,
			String cloudFileCentaDocTypeC, String cloudFileContentTypeC,
			String cloudFileConProjNoC, String cloudFileCreatedDateC,
			String cloudFileCustomerNumbersC, String cloudFileCuNoC,
			String cloudFileDepartmentC, String cloudFileDescriptionC,
			String cloudFileDoctitleC, String cloudFileDocumentRemarkC,
			String cloudFileDocumentTagC, String cloudFileDocRemarkC,
			String cloudFileFullNameC, String cloudHierarchiCustNoC,
			String cloudFileKissDocTypeC, String cloudFileMidC,
			String cloudFileOfferIdC, String cloudFilePathPrefixC,
			String cloudFileRelatedToIdC, String cloudFileStatusC,
			String cloudFileSupplietidC, String cloudFileTitleC,
			String cloudFileUploadedByC, String createdbyid,
			String createddate, String id, String isactiveC, String isdeleted,
			String lastmodifiedbyid, String lastmodifieddate,
			String lastreferenceddate, String lastvieweddate, String name,
			String ownerid, String systemmodstamp) {
		...
		this.cloudFileAllDocument = cloudFileAllDocument;
		...
		this.cloudFileFullNameC = cloudFileFullNameC;
		this.cloudHierarchiCustNoC = cloudHierarchiCustNoC;
		...
		this.cloudFileSupplietidC = cloudFileSupplietidC;
	...
	@Column(name = "CLOUD_FILE_ALL_DOCUMENT", length = 100)
	public String getCloudFileAllDocument() {
		return this.cloudFileAllDocument;
	}

	public void setCloudFileAllDocument(String cloudFileAllDocument) {
		this.cloudFileAllDocument = cloudFileAllDocument;
	}
	...
	@Column(name = "CLOUD_FILE_CON_PROJ_NO__C", length = 100)
	public String getCloudFileConProjNoC() {
		return this.cloudFileConProjNoC;
	}

	public void setCloudFileConProjNoC(String cloudFileConProjNoC) {
		this.cloudFileConProjNoC = cloudFileConProjNoC;
	}
	...
	@Column(name = "CLOUD_FILE_CU_NO__C", length = 100)
	public String getCloudFileCuNoC() {
		return this.cloudFileCuNoC;
	}

	public void setCloudFileCuNoC(String cloudFileCuNoC) {
		this.cloudFileCuNoC = cloudFileCuNoC;
	}
	...
	@Column(name = "CLOUD_FILE_FULL_NAME__C", length = 100)
	public String getCloudFileFullNameC() {
		return this.cloudFileFullNameC;
	}

	public void setCloudFileFullNameC(String cloudFileFullNameC) {
		this.cloudFileFullNameC = cloudFileFullNameC;
	}

	@Column(name = "CLOUD_HIERARCHI_CUST_NO__C", length = 100)
	public String getCloudHierarchiCustNoC() {
		return this.cloudHierarchiCustNoC;
	}

	public void setCloudHierarchiCustNoC(String cloudHierarchiCustNoC) {
		this.cloudHierarchiCustNoC = cloudHierarchiCustNoC;
	}
	...
	@Column(name = "CLOUD_FILE_SUPPLIETID__C", length = 100)
	public String getCloudFileSupplietidC() {
		return this.cloudFileSupplietidC;
	}

	public void setCloudFileSupplietidC(String cloudFileSupplietidC) {
		this.cloudFileSupplietidC = cloudFileSupplietidC;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Sf2073TestDataId))
			return false;
		Sf2073TestDataId castOther = (Sf2073TestDataId) other;
		...
		return ((this.getCentaDocumentNameC() == castOther
				...
				&& ((this.getCloudFileAllDocument() == castOther
						.getCloudFileAllDocument()) || (this
						.getCloudFileAllDocument() != null
						&& castOther.getCloudFileAllDocument() != null && this
						.getCloudFileAllDocument().equals(
								castOther.getCloudFileAllDocument())))
				...
				&& ((this.getCloudFileConProjNoC() == castOther
						.getCloudFileConProjNoC()) || (this
						.getCloudFileConProjNoC() != null
						&& castOther.getCloudFileConProjNoC() != null && this
						.getCloudFileConProjNoC().equals(
								castOther.getCloudFileConProjNoC())))
				...
				&& ((this.getCloudFileCuNoC() == castOther.getCloudFileCuNoC()) || (this
						.getCloudFileCuNoC() != null
						&& castOther.getCloudFileCuNoC() != null && this
						.getCloudFileCuNoC().equals(
								castOther.getCloudFileCuNoC())))
				...
				&& ((this.getCloudFileFullNameC() == castOther
						.getCloudFileFullNameC()) || (this
						.getCloudFileFullNameC() != null
						&& castOther.getCloudFileFullNameC() != null && this
						.getCloudFileFullNameC().equals(
								castOther.getCloudFileFullNameC())))
				&& ((this.getCloudHierarchiCustNoC() == castOther
						.getCloudHierarchiCustNoC()) || (this
						.getCloudHierarchiCustNoC() != null
						&& castOther.getCloudHierarchiCustNoC() != null && this
						.getCloudHierarchiCustNoC().equals(
								castOther.getCloudHierarchiCustNoC())))
				...
				&& ((this.getCloudFileSupplietidC() == castOther
						.getCloudFileSupplietidC()) || (this
						.getCloudFileSupplietidC() != null
						&& castOther.getCloudFileSupplietidC() != null && this
						.getCloudFileSupplietidC().equals(
								castOther.getCloudFileSupplietidC())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getCloudFileAllDocument() == null ? 0 : this
						.getCloudFileAllDocument().hashCode());
		result = 37
				* result
		...
		result = 37
				* result
				+ (getCloudFileConProjNoC() == null ? 0 : this
						.getCloudFileConProjNoC().hashCode());
		result = 37
				* result
		...
		result = 37
				* result
				+ (getCloudFileCuNoC() == null ? 0 : this.getCloudFileCuNoC()
						.hashCode());
		result = 37
				* result
		...
		result = 37
				* result
				+ (getCloudFileFullNameC() == null ? 0 : this
						.getCloudFileFullNameC().hashCode());
		result = 37
				* result
				+ (getCloudHierarchiCustNoC() == null ? 0 : this
						.getCloudHierarchiCustNoC().hashCode());
		result = 37
				* result
		...
		result = 37
				* result
				+ (getCloudFileSupplietidC() == null ? 0 : this
						.getCloudFileSupplietidC().hashCode());
		result = 37
				* result
