...
/**
 * Cableunitvaluelink generated by hbm2java
 */
@Entity
@Table(name = "CABLEUNITVALUELINK", schema = "PCRM")
public class Cableunitvaluelink implements java.io.Serializable {
	...
	public Cableunitvaluelink() {
	}

	public Cableunitvaluelink(String id) {
		this.id = id;
	}

	public Cableunitvaluelink(String id, Date crd, String cru, Date modd,
			String modu, Date deld, String delu, Date impd, String impu,
			Date expd, String expu, String primcableunit,
