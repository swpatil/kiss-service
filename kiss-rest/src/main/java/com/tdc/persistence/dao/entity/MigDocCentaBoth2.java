...
/**
 * MigDocCentaBoth2 generated by hbm2java
 */
@Entity
@Table(name = "MIG_DOC_CENTA_BOTH_2", schema = "PCRM")
public class MigDocCentaBoth2 implements java.io.Serializable {

	private MigDocCentaBoth2Id id;

	public MigDocCentaBoth2() {
	}

	public MigDocCentaBoth2(MigDocCentaBoth2Id id) {
		this.id = id;
	}
	...
	public MigDocCentaBoth2Id getId() {
		return this.id;
	}

	public void setId(MigDocCentaBoth2Id id) {
		this.id = id;
	}
