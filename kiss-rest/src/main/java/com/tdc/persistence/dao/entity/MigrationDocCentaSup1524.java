...
/**
 * MigrationDocCentaSup1524 generated by hbm2java
 */
@Entity
@Table(name = "MIGRATION_DOC_CENTA_SUP_1524", schema = "PCRM")
public class MigrationDocCentaSup1524 implements java.io.Serializable {

	private MigrationDocCentaSup1524Id id;

	public MigrationDocCentaSup1524() {
	}

	public MigrationDocCentaSup1524(MigrationDocCentaSup1524Id id) {
		this.id = id;
	}
	...
	public MigrationDocCentaSup1524Id getId() {
		return this.id;
	}

	public void setId(MigrationDocCentaSup1524Id id) {
		this.id = id;
	}
