...
/**
 * RequestcontentChghist generated by hbm2java
 */
@Entity
@Table(name = "REQUESTCONTENT_CHGHIST", schema = "PCRM")
public class RequestcontentChghist implements java.io.Serializable {
	...
	public RequestcontentChghist() {
	}

	public RequestcontentChghist(String audId) {
		this.audId = audId;
	}

	public RequestcontentChghist(String audId, String audAction,
			...
			Date crt, String code, String head, String primtilbkontr,
