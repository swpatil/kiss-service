...
/**
 * StaffactorChghistDrop generated by hbm2java
 */
@Entity
@Table(name = "STAFFACTOR_CHGHIST_DROP", schema = "PCRM")
public class StaffactorChghistDrop implements java.io.Serializable {
	...
	public StaffactorChghistDrop() {
	}

	public StaffactorChghistDrop(String audId) {
		this.audId = audId;
	}

	public StaffactorChghistDrop(String audId, String audAction,
			...
			String keyfieldvalue, String primaryowner, String primarycontact,
			String primaryrole) {
		this.audId = audId;
