...
/**
 * TestWorksmartData1 generated by hbm2java
 */
@Entity
@Table(name = "TEST_WORKSMART_DATA1", schema = "PCRM")
public class TestWorksmartData1 implements java.io.Serializable {

	private TestWorksmartData1Id id;

	public TestWorksmartData1() {
	}

	public TestWorksmartData1(TestWorksmartData1Id id) {
		this.id = id;
	}
	...
	public TestWorksmartData1Id getId() {
		return this.id;
	}

	public void setId(TestWorksmartData1Id id) {
		this.id = id;
	}
