...
/**
 * MigrationDocToAmazon1 generated by hbm2java
 */
@Entity
@Table(name = "MIGRATION_DOC_TO_AMAZON_1", schema = "PCRM")
public class MigrationDocToAmazon1 implements java.io.Serializable {
	...
	public MigrationDocToAmazon1() {
	}

	public MigrationDocToAmazon1(String id) {
		this.id = id;
	}

	public MigrationDocToAmazon1(String id, String fileName, String fullname,
			String bucketName, String cableunitno, String caseno,
