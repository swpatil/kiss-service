...
/**
 * SupplierproductspecChghist generated by hbm2java
 */
@Entity
@Table(name = "SUPPLIERPRODUCTSPEC_CHGHIST", schema = "PCRM")
public class SupplierproductspecChghist implements java.io.Serializable {
	...
	private String delu;
	private Date crt;
	private String primlev;
	private String primaryvare;
	private String code;
	private String head;
	private String vare;
	...
	public SupplierproductspecChghist() {
	}

	public SupplierproductspecChghist(String audId) {
		this.audId = audId;
	}

	public SupplierproductspecChghist(String audId, String audAction,
			...
			Date crt, String primlev, String primaryvare, String code,
			String head, String vare, String leverandor,
			BigDecimal prisprcolli, String colli, String primomktype,
			Character aktiv, String oldcode, Date startDate, Date endDate) {
		this.audId = audId;
		...
		this.delu = delu;
		this.crt = crt;
		this.primlev = primlev;
		this.primaryvare = primaryvare;
		this.code = code;
		this.head = head;
		this.vare = vare;
	...
	@Column(name = "PRIMLEV", length = 19)
	public String getPrimlev() {
		return this.primlev;
	}

	public void setPrimlev(String primlev) {
		this.primlev = primlev;
	}

	@Column(name = "PRIMARYVARE", length = 19)
	public String getPrimaryvare() {
		return this.primaryvare;
	}

	public void setPrimaryvare(String primaryvare) {
		this.primaryvare = primaryvare;
	}
