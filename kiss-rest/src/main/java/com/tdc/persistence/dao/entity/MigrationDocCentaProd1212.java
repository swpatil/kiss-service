...
/**
 * MigrationDocCentaProd1212 generated by hbm2java
 */
@Entity
@Table(name = "MIGRATION_DOC_CENTA_PROD_1212", schema = "PCRM")
public class MigrationDocCentaProd1212 implements java.io.Serializable {

	private MigrationDocCentaProd1212Id id;

	public MigrationDocCentaProd1212() {
	}

	public MigrationDocCentaProd1212(MigrationDocCentaProd1212Id id) {
		this.id = id;
	}
	...
	public MigrationDocCentaProd1212Id getId() {
		return this.id;
	}

	public void setId(MigrationDocCentaProd1212Id id) {
		this.id = id;
	}
