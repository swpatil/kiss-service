...
/**
 * MigrationDocCentaUat1 generated by hbm2java
 */
@Entity
@Table(name = "MIGRATION_DOC_CENTA_UAT1", schema = "PCRM")
public class MigrationDocCentaUat1 implements java.io.Serializable {

	private MigrationDocCentaUat1Id id;

	public MigrationDocCentaUat1() {
	}

	public MigrationDocCentaUat1(MigrationDocCentaUat1Id id) {
		this.id = id;
	}
	...
	public MigrationDocCentaUat1Id getId() {
		return this.id;
	}

	public void setId(MigrationDocCentaUat1Id id) {
		this.id = id;
	}
