...
/**
 * DocumentsCenta generated by hbm2java
 */
@Entity
@Table(name = "DOCUMENTS_CENTA", schema = "PCRM")
public class DocumentsCenta implements java.io.Serializable {

	private DocumentsCentaId id;

	public DocumentsCenta() {
	}

	public DocumentsCenta(DocumentsCentaId id) {
		this.id = id;
	}
	...
	public DocumentsCentaId getId() {
		return this.id;
	}

	public void setId(DocumentsCentaId id) {
		this.id = id;
	}
