...
/**
 * MigDocCentaProdId generated by hbm2java
 */
@Embeddable
public class MigDocCentaProdId implements java.io.Serializable {
	...
	public MigDocCentaProdId() {
	}

	public MigDocCentaProdId(BigDecimal id, String fileName, String fullname,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MigDocCentaProdId))
			return false;
		MigDocCentaProdId castOther = (MigDocCentaProdId) other;
