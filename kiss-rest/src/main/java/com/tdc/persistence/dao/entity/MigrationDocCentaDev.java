...
/**
 * MigrationDocCentaDev generated by hbm2java
 */
@Entity
@Table(name = "MIGRATION_DOC_CENTA_DEV", schema = "PCRM")
public class MigrationDocCentaDev implements java.io.Serializable {

	private MigrationDocCentaDevId id;

	public MigrationDocCentaDev() {
	}

	public MigrationDocCentaDev(MigrationDocCentaDevId id) {
		this.id = id;
	}
	...
	public MigrationDocCentaDevId getId() {
		return this.id;
	}

	public void setId(MigrationDocCentaDevId id) {
		this.id = id;
	}
