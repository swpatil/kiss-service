...
/**
 * MigrationDocIDriveUat generated by hbm2java
 */
@Entity
@Table(name = "MIGRATION_DOC_I_DRIVE_UAT", schema = "PCRM")
public class MigrationDocIDriveUat implements java.io.Serializable {

	private MigrationDocIDriveUatId id;

	public MigrationDocIDriveUat() {
	}

	public MigrationDocIDriveUat(MigrationDocIDriveUatId id) {
		this.id = id;
	}
	...
	public MigrationDocIDriveUatId getId() {
		return this.id;
	}

	public void setId(MigrationDocIDriveUatId id) {
		this.id = id;
	}
