...
/**
 * MigrationDocIDrive1 generated by hbm2java
 */
@Entity
@Table(name = "MIGRATION_DOC_I_DRIVE_1", schema = "PCRM")
public class MigrationDocIDrive1 implements java.io.Serializable {

	private MigrationDocIDrive1Id id;

	public MigrationDocIDrive1() {
	}

	public MigrationDocIDrive1(MigrationDocIDrive1Id id) {
		this.id = id;
	}
	...
	public MigrationDocIDrive1Id getId() {
		return this.id;
	}

	public void setId(MigrationDocIDrive1Id id) {
		this.id = id;
	}
