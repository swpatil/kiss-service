...
/**
 * Sf2076 generated by hbm2java
 */
@Entity
@Table(name = "SF_2076", schema = "PCRM")
public class Sf2076 implements java.io.Serializable {
	...
	public Sf2076Id getId() {
		return this.id;
	}

	public void setId(Sf2076Id id) {
		this.id = id;
	}
