...
/**
 * MigrationDocCentaId generated by hbm2java
 */
@Embeddable
public class MigrationDocCentaId implements java.io.Serializable {
	...
	public MigrationDocCentaId() {
	}

	public MigrationDocCentaId(BigDecimal id, String fileName, String fullname,
			...
			String documentTag, String sfDocumentId) {
		this.id = id;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MigrationDocCentaId))
			return false;
		MigrationDocCentaId castOther = (MigrationDocCentaId) other;
