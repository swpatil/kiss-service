...
/**
 * MigrationDocCentaDevId generated by hbm2java
 */
@Embeddable
public class MigrationDocCentaDevId implements java.io.Serializable {
	...
	public MigrationDocCentaDevId() {
	}

	public MigrationDocCentaDevId(BigDecimal id, String fileName,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MigrationDocCentaDevId))
			return false;
		MigrationDocCentaDevId castOther = (MigrationDocCentaDevId) other;
