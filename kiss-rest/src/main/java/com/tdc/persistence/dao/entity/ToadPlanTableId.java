...
/**
 * ToadPlanTableId generated by hbm2java
 */
@Embeddable
public class ToadPlanTableId implements java.io.Serializable {
	...
	public ToadPlanTableId() {
	}

	public ToadPlanTableId(String statementId, BigDecimal planId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ToadPlanTableId))
			return false;
		ToadPlanTableId castOther = (ToadPlanTableId) other;
